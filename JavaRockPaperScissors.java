...
public class JavaRockPaperScissors implements ActionListener, MouseListener {
	...
	public void drawImage(JLabel label, String path) {
            ...
            ImageIcon img = new ImageIcon(getClass().getResource(path)); // set ImageIcon with the path argument
			label.setIcon(img); // set label with ImageIcon
	...
	// align gameStatus text
	public void placeGameStatus () {
		
		// get the text from gameStatusLabel and set it to variable status
		String status;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == startButton) {
			...
			modePanel.setVisible(true);	// turn modePanel visible	
